						...
						<div class="tab-pane active" id="A">
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="options[site_host]" value="<?php echo ($site_host); ?>">
										<span class="help-block" style="color: red;">提示：域名须以http://开头。</span>
									</div>
								</div>

                <div class="control-group">
                  <label class="control-label">网站LOGO上传：</label>
                  <div class="controls">
										<input type='hidden' name='options[site_logo]' id='thumb' value="<?php echo ((isset($site_logo) && ($site_logo !== ""))?($site_logo):''); ?>">
											<a href="javascript:upload_one_image('图片上传','#thumb');">
												<?php if(empty($site_logo)): ?><img src="/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id='thumb-preview' width='135' height='113' style='cursor: hand' />
												<?php else: ?>
													<img src="<?php echo sp_get_image_preview_url($site_logo);?>" id='thumb-preview' width='135' height='113' style='cursor: hand' /><?php endif; ?>
											</a>
											...
											<span class="help-block" style="color: red;">LOGO图片尺寸规格为160px*80px。</span>
                    </div>
								</div>
              <div class="control-group">
                  <label class="control-label">二维码上传：</label>
                  <div class="controls">
										<input type='hidden' name='options[site_erweima]' id='thumbs' value="<?php echo ((isset($site_erweima) && ($site_erweima !== ""))?($site_erweima):''); ?>">
											<a href="javascript:upload_one_image('图片上传','#thumbs');">
												<?php if(empty($site_erweima)): ?><img src="/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id='thumbs-preview' width='135' height='113' style='cursor: hand' />
												<?php else: ?>
													<img src="<?php echo sp_get_image_preview_url($site_erweima);?>" id='thumbs-preview' width='135' height='113' style='cursor: hand' /><?php endif; ?>
											</a>
											<input type="button" class="btn btn-small" onclick="$('#thumbs-preview').attr('src','/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png');$('#thumbs').val('');return false;" value="取消图片">
											<span class="help-block" style="color: red;">LOGO图片尺寸规格为200px*200px。</span>
                  </div>
								</div>
								<div class="control-group">

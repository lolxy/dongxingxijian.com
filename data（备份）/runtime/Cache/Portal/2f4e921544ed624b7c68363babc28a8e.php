					...
					<table class="table table-bordered">
						<tr>
							...
							<td>
								...
								<input type="text" style="width: 400px;" name="post[post_title]" value="<?php echo ($post["post_title"]); ?>" placeholder="请输入标题" />
							...
							<td>
								<div style="text-align: center;">
									...
									<a href="javascript:upload_one_image('图片上传','#thumb');">
										<?php if(empty($smeta['thumb'])): ?><img src="/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id='thumb-preview' width='135' height='113' style='cursor: hand' />
										<?php else: ?>
											<img src="<?php echo sp_get_image_preview_url($smeta['thumb']);?>" id='thumb-preview' width='135' height='113' style='cursor: hand' /><?php endif; ?>
									</a>
